...
class EpgmEdge(id: Id, labels: Labels, sourceId: Id, targetId: Id, properties: Properties, override var graphIds: IdSet) extends EpgmGraphElement(id, labels, properties, graphIds) with Edge {
