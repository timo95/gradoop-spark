...
object EpgmGveEdgeFactory extends GveEdgeFactory[L#E] {
  ...
  override def apply(id: Id, labels: Label, sourceId: Id, targetId: Id, properties: Properties, graphIds: IdSet): EpgmGveEdgeFactory = new EpgmGveEdgeFactory(id, labels, sourceId, targetId, properties, graphIds)
}