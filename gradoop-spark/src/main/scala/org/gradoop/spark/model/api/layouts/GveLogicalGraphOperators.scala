...
import org.gradoop.spark.model.api.graph.{LogicalGraph, LogicalGraphOperators}
...
trait GveLogicalGraphOperators[L <: GveLayoutType[L]] extends LogicalGraphOperators[L] {
this: LogicalGraph[L] =>
