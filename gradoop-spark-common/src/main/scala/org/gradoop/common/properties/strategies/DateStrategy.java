...
public class DateStrategy extends AbstractFixSizedPropertyValueStrategy<LocalDate> {
  ...
  @Override
  public LocalDate read(DataInputStream inputStream, byte typeByte) throws IOException {
    return DateTimeSerializer.deserializeDate(readBytes(inputStream, typeByte));
  }
  ...
  @Override
  int getSize() {
    return DateTimeSerializer.SIZEOF_DATE;
  }
  ...
  @Override
  public byte[] getBytes(LocalDate value) {
